...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2022 a las 17:22:50
...
--
CREATE DATABASE IF NOT EXISTS `actividad_11` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `actividad_11`;
...
INSERT INTO `persona` (`id`, `contraseña`, `usuario`, `nombre`, `apellido`, `mascota`, `email`, `telefono`) VALUES
(0, '', '', '', '', '', '', 0),
(1001, 'roro23', 'Rom89**', 'Romina', 'Schegel', 'Benji', 'rominaschegel8989@hotmail.com', 55556767),
(1002, 'sonson56', 'SoniaLulu', 'Sonia Lucia', 'Luccian]', 'Lobito', 'estrellas45celestiale@hotmail.com', 55768889),
(1003, 'helgaforever6', 'HS55', 'Helga', 'Schwarzt', 'Lunita', 'colosal45@gmail.com', 55462312),
(1004, '*7milagros7', 'Smic77', 'Sebastian', 'Michaux', 'Milagros', 'smic77@hotmail.com', 49556565),
(1005, 'pupilo639##', 'JulianMendez', 'Julian', 'Mendez', 'Osita', 'pepitopistolero@gmail.com', 45456798),
(1006, '666macbeth777', 'macbeth666', 'Elizabeth', 'MacDonell', 'kiara', 'macmacbeth666@gmail.com', 45453245);
--
...
(1, 'KUKI', 'Perez', 'Chichus', 'juaco234@hotmail.com', 'cgijuaco483', '1970-02-13'),
...
('root', '2022-11-09 20:59:03', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\"}');
...
USE `test`;
--
-- Base de datos: `ttrabajo`
--
CREATE DATABASE IF NOT EXISTS `ttrabajo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ttrabajo`;
COMMIT;
